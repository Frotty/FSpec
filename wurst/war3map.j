...
function CreateAllItems takes nothing returns nothing
    ...
    call CreateItem( 'texp', -3675.1, 4283.0 )
    call CreateItem( 'texp', -3580.1, 4299.2 )
    call CreateItem( 'texp', -3543.1, 4293.5 )
    call CreateItem( 'texp', -3463.0, 4278.4 )
    call CreateItem( 'texp', -3420.9, 4267.0 )
    call CreateItem( 'texp', -3343.3, 4205.9 )
    call CreateItem( 'texp', -3316.8, 4182.3 )
    call CreateItem( 'texp', -3275.9, 4115.9 )
    call CreateItem( 'texp', -3219.3, 4069.4 )
    call CreateItem( 'texp', -3206.5, 4099.5 )
    call CreateItem( 'texp', -3201.5, 4258.8 )
    call CreateItem( 'texp', -3195.9, 4178.6 )
    call CreateItem( 'texp', 3533.0, 3895.8 )
    call CreateItem( 'tkno', 3050.0, 3691.5 )
    call CreateItem( 'tkno', 3075.2, 3663.2 )
    call CreateItem( 'tkno', 3190.3, 3606.2 )
    call CreateItem( 'tkno', 3258.6, 3558.3 )
    call CreateItem( 'tkno', 3236.4, 3530.0 )
    call CreateItem( 'tkno', 3182.8, 3518.8 )
    call CreateItem( 'tkno', 3115.0, 3556.4 )
    call CreateItem( 'tkno', 3071.4, 3600.4 )
    call CreateItem( 'tkno', 3026.6, 3732.4 )
    call CreateItem( 'tkno', 3557.3, 3849.9 )
    call CreateItem( 'tkno', 3615.0, 3813.4 )
    call CreateItem( 'tkno', 3634.5, 3862.9 )
    call CreateItem( 'tkno', 3606.3, 3904.6 )
    call CreateItem( 'tkno', 3575.4, 3922.4 )
    call CreateItem( 'tkno', 3517.3, 3924.6 )
    call CreateItem( 'tkno', 3486.3, 3915.7 )
    call CreateItem( 'tkno', 3465.0, 3886.9 )
    call CreateItem( 'tkno', 3468.5, 3839.1 )
    call CreateItem( 'tkno', 3519.1, 3798.6 )
    call CreateItem( 'tkno', 3449.4, 3935.8 )
    call CreateItem( 'tkno', 3420.1, 3915.7 )
    call CreateItem( 'tkno', 3418.2, 3830.5 )
    call CreateItem( 'tkno', 3430.8, 3792.3 )
    call CreateItem( 'tkno', 3366.3, 3822.0 )
    call CreateItem( 'tkno', 3340.4, 3876.0 )
    call CreateItem( 'tkno', 3349.5, 3942.5 )
    call CreateItem( 'tkno', 3378.4, 3985.7 )
    call CreateItem( 'tkno', 3419.4, 3987.9 )
    call CreateItem( 'tkno', 3355.7, 4008.7 )
    call CreateItem( 'tkno', 3309.8, 3985.2 )
    call CreateItem( 'tkno', 3299.1, 3938.0 )
    call CreateItem( 'tkno', 3307.8, 3889.1 )
    call CreateItem( 'tkno', 3323.5, 3800.7 )
    call CreateItem( 'tkno', 3258.3, 3822.0 )
    call CreateItem( 'tkno', 3215.9, 3876.0 )
    call CreateItem( 'tkno', 3198.6, 3937.8 )
    call CreateItem( 'tkno', 3206.4, 3976.3 )
    call CreateItem( 'tkno', 3222.8, 3841.3 )
    call CreateItem( 'tkno', 3354.6, 3783.8 )
    call CreateItem( 'tkno', 3361.6, 3752.6 )
    call CreateItem( 'tkno', 3309.4, 3734.0 )
    call CreateItem( 'tkno', 3244.9, 3738.1 )
    call CreateItem( 'tkno', 3201.9, 3756.7 )
    call CreateItem( 'tkno', 3163.7, 3809.2 )
    call CreateItem( 'tkno', 3152.8, 3876.1 )
    call CreateItem( 'tkno', 3149.7, 3909.7 )
    call CreateItem( 'tkno', 3141.1, 3839.9 )
    call CreateItem( 'tkno', 3398.1, 3719.7 )
    call CreateItem( 'tkno', 3302.1, 3677.2 )
    call CreateItem( 'tkno', 3246.2, 3675.2 )
    call CreateItem( 'tkno', 3188.4, 3689.2 )
    call CreateItem( 'tkno', 3144.5, 3721.2 )
    call CreateItem( 'tkno', 3087.2, 3770.1 )
    call CreateItem( 'tkno', 3330.2, 3655.3 )
    call CreateItem( 'tkno', 3381.3, 3675.2 )
    call CreateItem( 'tkno', 3342.7, 3621.8 )
    call CreateItem( 'tkno', 3277.9, 3612.1 )
    call CreateItem( 'tkno', 3242.2, 3616.0 )
    call CreateItem( 'tkno', 3138.5, 3617.9 )
    call CreateItem( 'tkno', 3110.5, 3663.2 )
    call CreateItem( 'tkno', 3088.0, 3711.5 )
    call CreateItem( 'tkno', 3068.3, 3839.3 )
    call CreateItem( 'tkno', 3084.2, 3884.2 )
    call CreateItem( 'tkno', 3042.8, 3883.0 )
    call CreateItem( 'tkno', 3008.0, 3833.7 )
    call CreateItem( 'tkno', 3009.2, 3776.1 )
    call CreateItem( 'tkno', 3043.5, 3621.6 )
    call CreateItem( 'tpow', -3574.0, 3906.0 )
    call CreateItem( 'tpow', -3598.2, 3962.4 )
    call CreateItem( 'tpow', -3545.9, 4017.9 )
    call CreateItem( 'tpow', -3492.2, 4072.3 )
    call CreateItem( 'tpow', -3490.6, 4120.4 )
    call CreateItem( 'tpow', -3548.7, 4170.4 )
    call CreateItem( 'tpow', -3616.7, 4159.6 )
    call CreateItem( 'tpow', -3767.4, 4074.6 )
    call CreateItem( 'tpow', -3539.7, 3880.7 )
endfunction
...
function CreateUnitsForPlayer0 takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'hpea', -1308.5, -279.5, 25.929 )
endfunction
...
function CreateNeutralHostile takes nothing returns nothing
    ...
    call SetUnitAcquireRange( u, 200.0 )
    set u = CreateUnit( p, 'nitp', -3338.0, 2937.7, 325.580 )
